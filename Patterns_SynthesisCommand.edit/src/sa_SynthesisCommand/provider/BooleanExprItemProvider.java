...
/**
 * This is the item provider adapter for a {@link sa_SynthesisCommand.BooleanExpr} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BooleanExprItemProvider extends ExpressionItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SaPackage.Literals.BOOLEAN_EXPR__OPERATOR,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SaPackage.Literals.BOOLEAN_EXPR__LEFT_OPERAND);
			childrenFeatures.add(SaPackage.Literals.BOOLEAN_EXPR__RIGHT_OPERAND);
		}
	...
	public String getText(Object object) {
		String label = ((BooleanExpr)object).getName();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SaPackage.Literals.BOOLEAN_EXPR__LEFT_OPERAND,
		...
		newChildDescriptors.add
			(createChildParameter
				(SaPackage.Literals.BOOLEAN_EXPR__RIGHT_OPERAND,
				 SaFactory.eINSTANCE.createIntegerConst()));
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == SaPackage.Literals.BOOLEAN_EXPR__LEFT_OPERAND ||
			childFeature == SaPackage.Literals.BOOLEAN_EXPR__RIGHT_OPERAND;
