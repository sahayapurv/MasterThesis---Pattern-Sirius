 ...
 * </p>
 * <ul>
 *   <li>{@link sa.UnicastSendMessage#getReceiverName <em>Receiver Name</em>}</li>
 * </ul>
 *
 * @see sa.SaPackage#getUnicastSendMessage()
 * @model
 * @generated
 */
public interface UnicastSendMessage extends SendMessage {
	 ...
	 * @see sa.SaPackage#getUnicastSendMessage_ReceiverName()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link sa.UnicastSendMessage#getReceiverName <em>Receiver Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
