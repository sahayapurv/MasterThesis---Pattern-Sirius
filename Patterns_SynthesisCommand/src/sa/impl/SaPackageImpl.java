...
import sa.Action;
import sa.Actuate;
import sa.ArithmeticExpr;
import sa.ArithmeticOp;
import sa.BehaviouralElement;
import sa.BooleanConst;
import sa.BooleanExpr;
import sa.BooleanOp;
import sa.BroadcastSendMessage;
import sa.CallAsyncService;
import sa.CallSyncService;
import sa.Choice;
import sa.Component;
import sa.Constant;
import sa.ControlAction;
import sa.Controller;
import sa.DataDeclaration;
import sa.DataRef;
import sa.EnterMode;
import sa.EnumConst;
import sa.Enumeration;
import sa.Event;
import sa.ExitMode;
import sa.Expression;
import sa.ExternalMode;
import sa.Fork;
import sa.InMessagePort;
import sa.InitialMode;
import sa.IntegerConst;
import sa.Join;
import sa.Link;
import sa.LinkableElement;
import sa.MessagePort;
import sa.Mode;
import sa.MulticastSendMessage;
import sa.NullExp;
import sa.OutMessagePort;
import sa.PrimitiveDataDeclaration;
import sa.PrimitiveType;
import sa.RealConst;
import sa.ReceiveMessage;
import sa.RelationalExpr;
import sa.RelationalOp;
import sa.SAElement;
import sa.SaFactory;
import sa.SaPackage;
import sa.SendMessage;
import sa.Sense;
import sa.SenseAccelerometer;
import sa.SensePosition;
import sa.ServiceCall;
import sa.ServiceCallback;
import sa.SoftwareArchitecture;
import sa.StartTimer;
import sa.StopTimer;
import sa.StoreData;
import sa.StringConst;
import sa.Structure;
import sa.StructureConst;
import sa.StructureElement;
import sa.StructureMemberRef;
import sa.StructuredDataDeclaration;
import sa.StructuredDataType;
import sa.TimerFired;
import sa.UnicastSendMessage;
...
public class SaPackageImpl extends EPackageImpl implements SaPackage {
	...
	public void initializePackageContents() {
		...
		initEReference(getMode_Entries(), this.getEnterMode(), null, "entries", null, 1, -1, Mode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getSendMessage_DataExp(), this.getExpression(), null, "dataExp", null, 1, 1, SendMessage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getUnicastSendMessage_ReceiverName(), ecorePackage.getEString(), "receiverName", null, 1, 1, UnicastSendMessage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getMulticastSendMessage_ReceiverNames(), ecorePackage.getEString(), "receiverNames", null, 1, -1, MulticastSendMessage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getSense_DataRecipient(), this.getDataDeclaration(), null, "dataRecipient", null, 1, 1, Sense.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getSensePosition_DataRecipient(), this.getDataDeclaration(), null, "dataRecipient", null, 1, 1, SensePosition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getSenseAccelerometer_DataRecipient(), this.getDataDeclaration(), null, "dataRecipient", null, 1, 1, SenseAccelerometer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getReceiveMessage_FromMessagePorts(), this.getInMessagePort(), null, "fromMessagePorts", null, 1, -1, ReceiveMessage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getStructuredDataDeclaration_TypeExp(), this.getStructuredDataType(), null, "typeExp", null, 1, 1, StructuredDataDeclaration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
