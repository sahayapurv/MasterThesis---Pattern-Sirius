...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Sense Accelerometer</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link sa_SynthesisCommand.impl.SenseAccelerometerImpl#getDataDeclarationName <em>Data Declaration Name</em>}</li>
 *   <li>{@link sa_SynthesisCommand.impl.SenseAccelerometerImpl#getData <em>Data</em>}</li>
 *   <li>{@link sa_SynthesisCommand.impl.SenseAccelerometerImpl#getDataRecipient <em>Data Recipient</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SenseAccelerometerImpl extends ActionImpl implements SenseAccelerometer {
	/**
	 ...
	 * @generated
	 */
	protected SenseAccelerometerImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return SaPackage.Literals.SENSE_ACCELEROMETER;
	}
	...
	public void setDataDeclarationName(String newDataDeclarationName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SaPackage.SENSE_ACCELEROMETER__DATA_DECLARATION_NAME, oldDataDeclarationName, dataDeclarationName));
	}
	...
	public void setData(String newData) {
		...
		data = newData;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SaPackage.SENSE_ACCELEROMETER__DATA, oldData, data));
	}
	...
	public DataDeclaration getDataRecipient() {
		if (dataRecipient != null && dataRecipient.eIsProxy()) {
			...
			if (dataRecipient != oldDataRecipient) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SaPackage.SENSE_ACCELEROMETER__DATA_RECIPIENT, oldDataRecipient, dataRecipient));
			}
		}
	...
	public void setDataRecipient(DataDeclaration newDataRecipient) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SaPackage.SENSE_ACCELEROMETER__DATA_RECIPIENT, oldDataRecipient, dataRecipient));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case SaPackage.SENSE_ACCELEROMETER__DATA:
				return getData();
			case SaPackage.SENSE_ACCELEROMETER__DATA_RECIPIENT:
