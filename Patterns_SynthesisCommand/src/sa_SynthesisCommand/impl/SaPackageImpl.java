...
import sa_SynthesisCommand.Action;
import sa_SynthesisCommand.Actuate;
import sa_SynthesisCommand.ArithmeticExpr;
import sa_SynthesisCommand.ArithmeticOp;
import sa_SynthesisCommand.BehaviouralElement;
import sa_SynthesisCommand.BooleanConst;
import sa_SynthesisCommand.BooleanExpr;
import sa_SynthesisCommand.BooleanOp;
import sa_SynthesisCommand.BroadcastSendMessage;
import sa_SynthesisCommand.CallAsyncService;
import sa_SynthesisCommand.CallSyncService;
import sa_SynthesisCommand.Choice;
import sa_SynthesisCommand.Component;
import sa_SynthesisCommand.Constant;
import sa_SynthesisCommand.ControlAction;
import sa_SynthesisCommand.Controller;
import sa_SynthesisCommand.DataDeclaration;
import sa_SynthesisCommand.DataRef;
import sa_SynthesisCommand.EnterMode;
import sa_SynthesisCommand.EnumConst;
import sa_SynthesisCommand.Enumeration;
import sa_SynthesisCommand.Event;
import sa_SynthesisCommand.ExitMode;
import sa_SynthesisCommand.Expression;
import sa_SynthesisCommand.ExternalMode;
import sa_SynthesisCommand.Fork;
import sa_SynthesisCommand.InMessagePort;
import sa_SynthesisCommand.InitialMode;
import sa_SynthesisCommand.IntegerConst;
import sa_SynthesisCommand.Join;
import sa_SynthesisCommand.Link;
import sa_SynthesisCommand.LinkableElement;
import sa_SynthesisCommand.MessagePort;
import sa_SynthesisCommand.Mode;
import sa_SynthesisCommand.MulticastSendMessage;
import sa_SynthesisCommand.NullExp;
import sa_SynthesisCommand.OutMessagePort;
import sa_SynthesisCommand.PrimitiveDataDeclaration;
import sa_SynthesisCommand.PrimitiveType;
import sa_SynthesisCommand.RealConst;
import sa_SynthesisCommand.ReceiveMessage;
import sa_SynthesisCommand.RelationalExpr;
import sa_SynthesisCommand.RelationalOp;
import sa_SynthesisCommand.SAElement;
import sa_SynthesisCommand.SaFactory;
import sa_SynthesisCommand.SaPackage;
import sa_SynthesisCommand.SendMessage;
import sa_SynthesisCommand.Sense;
import sa_SynthesisCommand.SenseAccelerometer;
import sa_SynthesisCommand.SensePosition;
import sa_SynthesisCommand.ServiceCall;
import sa_SynthesisCommand.ServiceCallback;
import sa_SynthesisCommand.SoftwareArchitecture;
import sa_SynthesisCommand.StartTimer;
import sa_SynthesisCommand.StopTimer;
import sa_SynthesisCommand.StoreData;
import sa_SynthesisCommand.StringConst;
import sa_SynthesisCommand.Structure;
import sa_SynthesisCommand.StructureConst;
import sa_SynthesisCommand.StructureElement;
import sa_SynthesisCommand.StructureMemberRef;
import sa_SynthesisCommand.StructuredDataDeclaration;
import sa_SynthesisCommand.StructuredDataType;
import sa_SynthesisCommand.TimerFired;
import sa_SynthesisCommand.UnicastSendMessage;

import sa_SynthesisCommand.util.SaValidator;
...
public class SaPackageImpl extends EPackageImpl implements SaPackage {
	 ...
	 * @see sa_SynthesisCommand.SaPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
