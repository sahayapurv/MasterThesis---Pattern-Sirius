...
public class SaValidator extends EObjectValidator {
	 ...
	 * @generated
	 */
	public static final String DIAGNOSTIC_SOURCE = "sa_CollectOrganize";
	...
	protected boolean validate(int classifierID, Object value, DiagnosticChain diagnostics, Map<Object, Object> context) {
		switch (classifierID) {
			...
			case SaPackage.SENSOR_CONTROLLER:
				return validateSensorController((SensorController)value, diagnostics, context);
	 ...
	 * @generated
	 */
	public boolean validateSensorController(SensorController sensorController, DiagnosticChain diagnostics, Map<Object, Object> context) {
		if (!validate_NoCircularContainment(sensorController, diagnostics, context)) return false;
		boolean result = validate_EveryMultiplicityConforms(sensorController, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryDataValueConforms(sensorController, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryReferenceIsContained(sensorController, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryBidirectionalReferenceIsPaired(sensorController, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryProxyResolves(sensorController, diagnostics, context);
		if (result || diagnostics != null) result &= validate_UniqueID(sensorController, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryKeyUnique(sensorController, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryMapEntryUnique(sensorController, diagnostics, context);
		if (result || diagnostics != null) result &= validateSAElement_SAElementNameMustBeUnique(sensorController, diagnostics, context);
		if (result || diagnostics != null) result &= validateSAElement_NameMustNotContainWhiteSpace(sensorController, diagnostics, context);
		return result;
	}
	...
	public boolean validateInternalController(InternalController internalController, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateMode_NameMustNotContainWhiteSpace(internalController, diagnostics, context);
		return result;
	}
