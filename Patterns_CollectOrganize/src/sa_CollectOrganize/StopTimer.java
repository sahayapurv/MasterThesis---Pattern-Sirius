 ...
 * </p>
 * <ul>
 *   <li>{@link sa_CollectOrganize.StopTimer#getTimer <em>Timer</em>}</li>
 * </ul>
 *
 * @see sa_CollectOrganize.SaPackage#getStopTimer()
 * @model
 * @generated
 */
public interface StopTimer extends Action {
	 ...
	 * @see sa_CollectOrganize.SaPackage#getStopTimer_Timer()
	 * @model required="true"
	 * @generated
	 */
	StartTimer getTimer();
	...
	/**
	 * Sets the value of the '{@link sa_CollectOrganize.StopTimer#getTimer <em>Timer</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
