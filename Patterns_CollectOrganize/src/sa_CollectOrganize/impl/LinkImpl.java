 ...
 * </p>
 * <ul>
 *   <li>{@link sa_CollectOrganize.impl.LinkImpl#getSource <em>Source</em>}</li>
 *   <li>{@link sa_CollectOrganize.impl.LinkImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link sa_CollectOrganize.impl.LinkImpl#getConditionExp <em>Condition Exp</em>}</li>
 *   <li>{@link sa_CollectOrganize.impl.LinkImpl#getCondition <em>Condition</em>}</li>
 *   <li>{@link sa_CollectOrganize.impl.LinkImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LinkImpl extends MinimalEObjectImpl.Container implements Link {
	...
	/**
	 * The cached value of the '{@link #getConditionExp() <em>Condition Exp</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getConditionExp()
	 * @generated
	 * @ordered
	 */
	protected EList<Expression> conditionExp;
	 ...
	 * @generated
	 */
	public EList<Expression> getConditionExp() {
		if (conditionExp == null) {
			conditionExp = new EObjectContainmentEList<Expression>(Expression.class, this, SaPackage.LINK__CONDITION_EXP);
		}
		return conditionExp;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case SaPackage.LINK__CONDITION_EXP:
				return ((InternalEList<?>)getConditionExp()).basicRemove(otherEnd, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case SaPackage.LINK__TARGET:
				...
				return;
			case SaPackage.LINK__CONDITION_EXP:
				getConditionExp().clear();
				getConditionExp().addAll((Collection<? extends Expression>)newValue);
				return;
			case SaPackage.LINK__CONDITION:
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case SaPackage.LINK__TARGET:
				return target != null;
			case SaPackage.LINK__CONDITION_EXP:
				return conditionExp != null && !conditionExp.isEmpty();
			case SaPackage.LINK__CONDITION:
