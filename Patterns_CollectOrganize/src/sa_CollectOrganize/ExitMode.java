 ...
 * </p>
 * <ul>
 *   <li>{@link sa_CollectOrganize.ExitMode#getTargetMode <em>Target Mode</em>}</li>
 * </ul>
 *
 * @see sa_CollectOrganize.SaPackage#getExitMode()
 * @model
 * @generated
 */
public interface ExitMode extends Action {
	 ...
	 * @see sa_CollectOrganize.SaPackage#getExitMode_TargetMode()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link sa_CollectOrganize.ExitMode#getTargetMode <em>Target Mode</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
