 ...
 * </p>
 * <ul>
 *   <li>{@link sa_SynthesisUtilize.ExitMode#getTargetMode <em>Target Mode</em>}</li>
 * </ul>
 *
 * @see sa_SynthesisUtilize.SaPackage#getExitMode()
 * @model
 * @generated
 */
public interface ExitMode extends Action {
	 ...
	 * @see sa_SynthesisUtilize.SaPackage#getExitMode_TargetMode()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link sa_SynthesisUtilize.ExitMode#getTargetMode <em>Target Mode</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
