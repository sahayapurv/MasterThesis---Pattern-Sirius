 ...
 * </p>
 * <ul>
 *   <li>{@link sa_SynthesisUtilize.impl.SensePositionImpl#getDataDeclarationName <em>Data Declaration Name</em>}</li>
 *   <li>{@link sa_SynthesisUtilize.impl.SensePositionImpl#getData <em>Data</em>}</li>
 *   <li>{@link sa_SynthesisUtilize.impl.SensePositionImpl#getDataRecipient <em>Data Recipient</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SensePositionImpl extends ActionImpl implements SensePosition {
	/**
	...
	protected EClass eStaticClass() {
		return SaPackage.Literals.SENSE_POSITION;
	}
	...
	public void setDataDeclarationName(String newDataDeclarationName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SaPackage.SENSE_POSITION__DATA_DECLARATION_NAME, oldDataDeclarationName, dataDeclarationName));
	}
	...
	public void setData(String newData) {
		...
		data = newData;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SaPackage.SENSE_POSITION__DATA, oldData, data));
	}
	...
	public DataDeclaration getDataRecipient() {
		if (dataRecipient != null && dataRecipient.eIsProxy()) {
			...
			if (dataRecipient != oldDataRecipient) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SaPackage.SENSE_POSITION__DATA_RECIPIENT, oldDataRecipient, dataRecipient));
			}
		}
	...
	public void setDataRecipient(DataDeclaration newDataRecipient) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SaPackage.SENSE_POSITION__DATA_RECIPIENT, oldDataRecipient, dataRecipient));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case SaPackage.SENSE_POSITION__DATA:
				return getData();
			case SaPackage.SENSE_POSITION__DATA_RECIPIENT:
