...
import sa_SynthesisUtilize.Action;
import sa_SynthesisUtilize.Actuate;
import sa_SynthesisUtilize.ArithmeticExpr;
import sa_SynthesisUtilize.ArithmeticOp;
import sa_SynthesisUtilize.BehaviouralElement;
import sa_SynthesisUtilize.BooleanConst;
import sa_SynthesisUtilize.BooleanExpr;
import sa_SynthesisUtilize.BooleanOp;
import sa_SynthesisUtilize.BroadcastSendMessage;
...
import sa_SynthesisUtilize.ControlAction;
...
import sa_SynthesisUtilize.EnumConst;
import sa_SynthesisUtilize.Enumeration;
import sa_SynthesisUtilize.Event;
...
import sa_SynthesisUtilize.IntegerConst;
import sa_SynthesisUtilize.InternalController;
import sa_SynthesisUtilize.Join;
import sa_SynthesisUtilize.Link;
import sa_SynthesisUtilize.LinkableElement;
import sa_SynthesisUtilize.MessagePort;
import sa_SynthesisUtilize.Mode;
import sa_SynthesisUtilize.MulticastSendMessage;
import sa_SynthesisUtilize.NullExp;
...
import sa_SynthesisUtilize.RealConst;
import sa_SynthesisUtilize.ReceiveMessage;
...
import sa_SynthesisUtilize.SenseAccelerometer;
import sa_SynthesisUtilize.SensePosition;
import sa_SynthesisUtilize.ServiceCall;
import sa_SynthesisUtilize.ServiceCallback;
import sa_SynthesisUtilize.SoftwareArchitecture;
import sa_SynthesisUtilize.StartTimer;
import sa_SynthesisUtilize.StopTimer;
import sa_SynthesisUtilize.StoreData;
import sa_SynthesisUtilize.StringConst;
import sa_SynthesisUtilize.Structure;
import sa_SynthesisUtilize.StructureConst;
import sa_SynthesisUtilize.StructureElement;
import sa_SynthesisUtilize.StructureMemberRef;
...
import sa_SynthesisUtilize.util.SaValidator;
...
public class SaPackageImpl extends EPackageImpl implements SaPackage {
	 ...
	 * @see sa_SynthesisUtilize.SaPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEReference(getSendMessage_ToMessagePorts(), this.getOutMessagePort(), null, "toMessagePorts", null, 0, -1, SendMessage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createEcoreAnnotations() {
		...
		addAnnotation
		  (behaviouralElementEClass, 
		   source, 
		   new String[] {
			 "constraints", "BehaviouralElementNameMustBeUnique"
		   });
	}
	...
	protected void createPivotAnnotations() {
		...
		addAnnotation
		  (behaviouralElementEClass, 
		   source, 
		   new String[] {
			 "BehaviouralElementNameMustBeUnique", "Mode.allInstances().behaviouralElements->select(s : BehaviouralElement | s.name = self.name)->size() = 1"
		   });
	}
