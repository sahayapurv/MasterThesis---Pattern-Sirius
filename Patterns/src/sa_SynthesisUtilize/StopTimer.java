 ...
 * </p>
 * <ul>
 *   <li>{@link sa_SynthesisUtilize.StopTimer#getTimer <em>Timer</em>}</li>
 * </ul>
 *
 * @see sa_SynthesisUtilize.SaPackage#getStopTimer()
 * @model
 * @generated
 */
public interface StopTimer extends Action {
	 ...
	 * @see sa_SynthesisUtilize.SaPackage#getStopTimer_Timer()
	 * @model required="true"
	 * @generated
	 */
	StartTimer getTimer();
	...
	/**
	 * Sets the value of the '{@link sa_SynthesisUtilize.StopTimer#getTimer <em>Timer</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
