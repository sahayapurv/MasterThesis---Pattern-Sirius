 ...
 * @model abstract="true"
 *        annotation="http://www.eclipse.org/emf/2002/Ecore constraints='ModeNameMustBeUnique'"
 *        annotation="http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot ModeNameMustBeUnique='SAElement.allInstances().modes-&gt;select(s : Mode | s.name = self.name)-&gt;size() = 1'"
 * @generated
 */
